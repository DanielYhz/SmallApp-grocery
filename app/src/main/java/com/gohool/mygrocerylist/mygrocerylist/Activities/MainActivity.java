...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast myToast = Toast.makeText(getApplicationContext(), "What you need to buy this week?", Toast.LENGTH_LONG);
        myToast.setGravity(Gravity.CENTER, 10,10);
        myToast.setMargin(0.5f,0.6f);
        LinearLayout mLayoutToastView = new LinearLayout(getApplicationContext());
        mLayoutToastView.setOrientation(LinearLayout.HORIZONTAL);
        myToast.show();
